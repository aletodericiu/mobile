...
- There are two types of users: 
	-> normal user: can only see the data, the details about it and
		also the chart, the map
	-> manager: can add a new song in the application and also have 
		the normal user's rights
- You can add a new presentation in the application to a new record
that appeared on the market.
- You can see the presentation of all the records from the application.
- You can see the percentage of the music genres based on the records
